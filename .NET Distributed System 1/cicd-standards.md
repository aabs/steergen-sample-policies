...
:::rule id="STD-CI-001" category="pre-commit" tags="cicd, pre-commit, repositories, git, hooks, check"
All repositories shall use git pre-commit hooks to check code quality before commits.
:::

## Pipeline Gates

:::rule id="STD-CI-010" category="pipeline" tags="cicd, pipeline, runs, execute, format, check"
