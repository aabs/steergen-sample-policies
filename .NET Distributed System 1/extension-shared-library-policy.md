...
:::rule id="STD-EXT-001" category="extensibility" domain="extension" tags="extension, extensibility, adding, capability, register, new"
When adding new capability, the developer shall register new modules rather than modifying core logic.
:::

:::rule id="STD-EXT-002" category="extensibility" domain="extension" tags="extension, extensibility, approved, mechanisms, ui, module"
...
:::rule id="STD-EXT-010" category="libraries" domain="extension" tags="extension, libraries, approved, shared, auth, sdk"
...
:::rule id="STD-EXT-011" category="libraries" domain="extension" tags="extension, libraries, other, domain-owned, unnecessary, shared"
