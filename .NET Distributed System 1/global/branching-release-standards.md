...
:::rule id="STD-REL-001" severity="error" category="branching" domain="release"
title: Feature Branch Development

All changes shall be developed on feature branches.
:::

:::rule id="STD-REL-002" severity="error" category="branching" domain="release"
title: Develop Branch Integration

The `develop` branch shall be used for integration.
:::

:::rule id="STD-REL-003" severity="error" category="branching" domain="release"
title: Main Branch Release Quality

The `main` branch shall always be at release quality.
:::

:::rule id="STD-REL-004" severity="error" category="branching" domain="release"
title: Production Release Source
...
:::rule id="STD-REL-010" severity="error" category="review" domain="release"
title: Peer Review Requirement

When submitting a pull request, the developer shall obtain peer review and approval before merging.
:::

:::rule id="STD-REL-011" severity="error" category="review" domain="release"
...
:::rule id="STD-REL-020" severity="error" category="deployment" domain="release"
title: Feature Flag Management

Where feature flags are used, they shall be managed via AWS AppConfig.
:::

:::rule id="STD-REL-021" severity="error" category="deployment" domain="release"
title: High-Risk Deployment Strategy

Where high-risk components are deployed, the deployment shall use canary or blue-green strategy.
:::

:::rule id="STD-REL-022" severity="error" category="deployment" domain="release"
