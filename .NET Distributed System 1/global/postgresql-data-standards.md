...
:::rule id="STD-DB-001" severity="error" category="database" domain="data"
title: PostgreSQL Version

The system shall use PostgreSQL ≥ 14 for all persistent storage.
:::

:::rule id="STD-DB-002" severity="error" category="database" domain="data"
...
:::rule id="STD-DB-010" severity="error" category="migrations" domain="data"
...
:::rule id="STD-DB-011" severity="error" category="data-integrity" domain="data"
...
:::rule id="STD-DB-020" severity="error" category="events" domain="data"
title: Event Capture

All domain state changes shall be captured as immutable events in the Marten event store.
:::

:::rule id="STD-DB-021" severity="error" category="messaging" domain="data"
title: Wolverine Message Queue Storage
