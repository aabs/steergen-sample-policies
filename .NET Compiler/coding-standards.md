...
:::rule id="CODE-004" category="quality" domain="coding"
...
:::rule id="CODE-007" category="cli" domain="coding"
...
:::rule id="CODE-018" category="security" domain="coding"
Avoid executing arbitrary code during generation or parsing.
:::

:::rule id="CODE-019" category="security" domain="coding"
Validate inputs and keep user inputs separated from internal templates.
:::

:::rule id="CODE-020" category="security" domain="coding"
